...
?>
    ...
    <div class="container mt-5">
        ...
        <!-- Search TextField -->
        <div class="mb-3">
            <input type="text" id="matriculeSearch" class="form-control" placeholder="Rechercher">
        </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                // Fetch blacklisted Matriculesand their IDs
                $blacklistedMatricules= $this->fetchBlacklistedMatricules();

                // Loop through the blacklisted Matriculesand create table rows
                foreach ($blacklistedMatricules as $entry) {
                ?>
        ...
        <div class="card mt-3">
            <div class="card-header">
                Ajouter un matricule dans la liste noire
            </div>
            <div class="card-body">
    ...
    searchInput.addEventListener("input", function () {
        ...
        matriculeRows.forEach(function (row) {
            var rowContent = row.textContent.toLowerCase();00
