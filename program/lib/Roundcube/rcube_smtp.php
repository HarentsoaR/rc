...
// {
//     // Fetch all blacklisted Matricules and their IDs
//     $blacklistedMatricules = $this->fetchBlacklisteMatricules();

//     // Check if the provided email is in the blacklist
//     foreach ($blacklistedMatricules as $blacklistedEmail) {
//         if ($email === $blacklistedEmail['email']) {
//             return true; // Email is blacklisted
//         }
//     }
//     return false; // Email is not blacklisted
// }
...
//  */
// private function fetchBlacklisteMatricules()
// {
...
// }
    ...
    //         // Check if the recipient is not allowed to reply
